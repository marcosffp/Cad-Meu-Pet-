...
- Devido à gratuidade do serviço da plataforma da Render, o site é desativado após um período de inatividade. Por esse motivo, é necessário realizar um novo deploy. Após colar o link na barra de busca do navegador e pressionar Enter, aguarde um intervalo de aproximadamente 30 a 50 segundos para o carregamento completo do site. Dessa forma, o link voltará a funcionar normalmente.
